...
const FeaturesSection = () => {
  const features = [
    { title: "E-learning", desc: "Access curated learning modules anytime.", emoji: "📚" },
    { title: "Mentorship", desc: "Connect with experienced mentors.", emoji: "🧑‍🏫" },
    { title: "Toolkits", desc: "Download resources to start your journey.", emoji: "🧰" },
    { title: "AI Assistant", desc: "Ask questions, get help—instantly.", emoji: "🤖" },
  ];
