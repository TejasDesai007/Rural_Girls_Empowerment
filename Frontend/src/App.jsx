...
import EntrepreneurCorner from "./pages/entrepreneur/EntrepreneurCorner"; // Add this import
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/entrepreneur-corner" element={<EntrepreneurCorner />} /> {/* New route */}
